...
loc_set = set(['Texas', 'California', 'Tokyo'])
# loc_set = set(['Berlin', 'Brandenburg', 'Bavaria', 'North Rhine-Westphalia', 'Schleswig-Holstein', 'Hamburg', 'Hesse', 'Baden-Wuerttemberg', 'Lower Saxony', 'Saxony'])
